...
st.write("This classification model can be used to identify the diseases of variety of plants like apple, blueberry, cherry, corn, grape, orange, pepper, potato, strawberry, tomato")
